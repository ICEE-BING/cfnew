# CFnew - 终端 v2.2 (GitHub Mirror)

<div align="center" style="margin-bottom: 20px;">

**语言 / زبان:** [🇨🇳 中文](README_zh-CN.md) | [🇺🇸 English](README.md) | [🇮🇷 فارسی](فارسی.md)
...
[![Sync Status](https://img.shields.io/badge/Sync-Daily-brightgreen)]()

</div>

## 📢 关于此镜像仓库

本仓库是 [byJoey/cfnew](https://github.com/byJoey/cfnew) 的官方 GitHub 镜像仓库，提供以下功能：

- 🔄 **每日自动同步** - 每天自动从上游仓库同步最新代码
- 🚀 **持续可用性** - 提供额外的访问途径和冗余备份
- 🌐 **全球访问** - 通过 GitHub 提供稳定的全球访问

### 同步机制

本镜像仓库通过 GitHub Actions 实现自动同步：
- **同步频率**: 每天 UTC 00:00 自动执行
- **上游仓库**: [byJoey/cfnew](https://github.com/byJoey/cfnew)
- **同步策略**: 自动合并上游更新，冲突时保留上游代码
- **手动触发**: 可通过 Actions 页面手动触发同步

如需查看同步状态，请访问仓库的 [Actions](../../actions) 页面。
...
### 上游项目
- 主项目：[byJoey/cfnew](https://github.com/byJoey/cfnew)
- 原始项目：[zizifn/edgetunnel](https://github.com/zizifn/edgetunnel)
...
- 本项目反代IP来自前端独苗kejiland [[qwer-search](https://github.com/qwer-search)]，感谢作者的贡献
